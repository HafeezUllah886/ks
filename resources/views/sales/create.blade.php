                           ...
                           <div class="col-3"></div>
                            ...
                            <div class="col-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="tax" id="tax" oninput="updateTax()" min="0" max="100" step="any" value="6" class="form-control no_zero">
                            ...
                            <div class="col-12 mt-2">
                                <div class="form-group">
                                    ...
                                    <textarea name="notes" id="notes" class="form-control" cols="30" rows="5">All goederen blijven eigendom van etemad food and drinks totdat de volledige betaling is ontvangen, elk defect of klacht dient bij levering te worden gemeld. Na levering is eventuele losse of beschadiging voor rekening van de klant.</textarea>
                                </div>
                            </div>
                            <div class="col-12 mt-2">
...
@section('page-js')
    ...
    <script>
            ...
            $.ajax({
                ...
                success: function(product) {
                    ...
                    if (found.length > 0) {
                        ...
                        html += '</select></td>';
                        html += '<td class="no-padding"><input type="number" name="qty[]" oninput="updateChanges(' + id +')" min="0" step="any" value="1" class="form-control text-center no-padding" id="qty_' + id + '"></div></td>';
                        ...
                        html += '<td class="no-padding"><input type="number" name="pTax[]" readonly step="any" value="0" class="form-control text-center no-padding" id="ptax_' + id + '"></td>';
                        ...
                        html += '<input type="hidden" name="id[]" id="product_'+id+'" value="' + id + '">';
        ...
        function updateChanges(id) {
            ...
            var taxValue = price * tax / 100;
            $("#ptax_"+id).val(taxValue * qty);

            var amount = (price + taxValue) * qty;
        ...
        function updateTax()
        {
            $("input[id^='product_']").each(function() {
                var inputId = $(this).val();
                updateChanges(inputId);
            });
        }
