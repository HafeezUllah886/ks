                    ...
                    <div class="col-lg-12">
                        <div class="text-center">
                            <p class="mb-0 text-muted">&copy;
                                <script>document.write(new Date().getFullYear())</script> BMS. Crafted with <i class="mdi mdi-heart text-danger"></i> by <a href="https://wa.me/923088396356">Nexgen Pakistan</a>
                            </p>
                        </div>
                    </div>
                </div>
